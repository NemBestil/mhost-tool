...
INSERT INTO "new_wordpress_installations" ("adminEmail", "adminEmailFromName", "autoLoginUser", "currentCve", "hasWooCommerce", "id", "installationPath", "lastScanAt", "monitoringCurrentStatusSince", "monitoringFailedAttempts", "monitoringFrontpageStatusMax", "monitoringFrontpageStatusMin", "monitoringLastCheckedAt", "monitoringLevel", "monitoringStatus", "monitoringTestWpLogin", "phpMemoryLimit", "phpVersion", "serverId", "siteDescription", "siteTitle", "siteUrl", "timezone", "unixUsername", "usesServerCron", "wooCommerceEmail", "wooCommerceEmailFromName") SELECT "adminEmail", "adminEmailFromName", "autoLoginUser", "currentCve", "hasWooCommerce", "id", "installationPath", "lastScanAt", "monitoringCurrentStatusSince", "monitoringFailedAttempts", "monitoringFrontpageStatusMax", "monitoringFrontpageStatusMin", "monitoringLastCheckedAt", "monitoringLevel", "monitoringStatus", "monitoringTestWpLogin", "phpMemoryLimit", "phpVersion", "serverId", "siteDescription", "siteTitle", "siteUrl", "timezone", "unixUsername", "usesServerCron", "wooCommerceEmail", "wooCommerceEmailFromName" FROM "wordpress_installations";
